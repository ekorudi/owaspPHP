...
<div class="login-clean">
        <form method="post" action="<?php echo $host;?>function/actSignin.php">
            ...
            <div class="form-group"><button class="btn btn-primary btn-block g-recaptcha" data-sitekey="6LeY5DQfAAAAABxf9eSPGvPzYKylL_S68sLvtvmb" data-callback='onSubmit' data-action='submit'type="submit">Sign In</button>
            </div><a class="forgot" href="forgotPassword.php">Forgot your email or password?</a></form>
</div>
